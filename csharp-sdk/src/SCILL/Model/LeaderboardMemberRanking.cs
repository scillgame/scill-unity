...
namespace SCILL.Model
{
        ...
        public partial class LeaderboardMemberRanking :  IEquatable<LeaderboardMemberRanking>, IValidatableObject
    {
        ...
        public LeaderboardMemberRanking(string leaderboardId = default(string), string leaderboardName = default(string), bool? leaderboardSortOrderAscending = default(bool?), List<LeaderboardMember> leaderboardMember = default(List<LeaderboardMember>))
        {
        ...
        public List<LeaderboardMember> leaderboard_member { get; set; }
