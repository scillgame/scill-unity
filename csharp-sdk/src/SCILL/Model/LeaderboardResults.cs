...
namespace SCILL.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LeaderboardResults :  IEquatable<LeaderboardResults>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LeaderboardResults" /> class.
        /// </summary>
        ...
        public LeaderboardResults(string leaderboardId = default(string), string leaderboardName = default(string), bool? leaderboardSortOrderAscending = default(bool?), List<LeaderboardMemberTypeRanking> leaderboardResultsByMemberType = default(List<LeaderboardMemberTypeRanking>))
        {
        ...
        public List<LeaderboardMemberTypeRanking> leaderboard_results_by_member_type { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LeaderboardResults {\n");
        ...
        {
            return this.Equals(input as LeaderboardResults);
        }

        /// <summary>
        /// Returns true if LeaderboardResults instances are equal
        /// </summary>
        /// <param name="input">Instance of LeaderboardResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LeaderboardResults input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    input.leaderboard_results_by_member_type != null &&
                    this.leaderboard_results_by_member_type.SequenceEqual(input.leaderboard_results_by_member_type)
                );
        }
